...
WHERE USER_ID = ".$_SESSION['v_id']." AND order_head.D_ID = delivery.D_ID";
...
mysqli_close($mysqli);
?>
<p><center><a href="order.php?userid=<?=$_SESSION['v_id']?>"><button type="button" class="btn btn-warning btn-sm">Back to Order</button></a></center>
</body>
</html>